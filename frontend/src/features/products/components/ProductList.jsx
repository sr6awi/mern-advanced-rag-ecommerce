...
export const ProductList = () => {
  // Always start with empty arrays for filters!
  ...
  // MULTI-SELECT LOGIC (checked state always synced)
          ...
          <>
            <motion.div style={{ position: "fixed", backgroundColor: "white", height: "100vh", padding: '1rem', overflowY: "scroll", width: is500 ? "100vw" : "30rem", zIndex: 500 }} variants={{ show: { left: 0 }, hide: { left: -500 } }} initial={'hide'} transition={{ ease: "easeInOut", duration: .7, type: "spring" }} animate={isProductFilterOpen === true ? "show" : "hide"}>
              ...
              <Stack mb={'5rem'} sx={{ scrollBehavior: "smooth", overflowY: "scroll" }}>
                ...
                <Stack rowGap={2} mt={4}>
                  <Typography sx={{ cursor: "pointer" }} variant='body2'>Apple Vision Pro</Typography>
                  <Typography sx={{ cursor: "pointer" }} variant='body2'>Fossil Men's Watch</Typography>
                  <Typography sx={{ cursor: "pointer" }} variant='body2'>Uniqlo U Crew Neck T-Shirts</Typography>
                  <Typography sx={{ cursor: "pointer" }} variant='body2'>Sony WH-1000XM3 Headphones</Typography>
                  <Typography sx={{ cursor: "pointer" }} variant='body2'>Yves Saint Laurent Libre Perfume</Typography>
                </Stack>
