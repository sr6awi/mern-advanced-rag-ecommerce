    ...
    <Stack sx={{backgroundColor:theme.palette.primary.main,paddingTop:"3rem",paddingLeft:is700?"1rem":"3rem",paddingRight:is700?"1rem":"3rem",paddingBottom:"1.5rem",rowGap:"5rem",color:theme.palette.primary.light,justifyContent:"space-around"}}>
            ...
            <Stack flexDirection={'row'} rowGap={'1rem'} justifyContent={is700?"":'space-around'} flexWrap={'wrap'}>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    <Typography variant='h6' fontSize={'1.5rem'}>IntelliMart</Typography>
                    <Typography variant='h6'>Subscribe</Typography>
                    <Typography sx={labelStyles}>Smart shopping powered by AI</Typography>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={labelStyles}>11th AD Street, Abudhabi,  NI 4050, KTC.</Typography>
                    <Typography sx={labelStyles}>AI_engineering@ciu.com</Typography>
                    <Typography sx={labelStyles}>+971 54 741 7401</Typography>
                </Stack>
                ...
                <Stack rowGap={'1rem'} padding={'1rem'}>
                    ...
                    <Typography sx={{...labelStyles,color:"graytext",fontWeight:500}}>Donation With Each Download</Typography>
            ...
            <Typography color={'GrayText'}>
             &copy; CIU SHOP {new Date().getFullYear()}. All rights reserved.
            </Typography>
